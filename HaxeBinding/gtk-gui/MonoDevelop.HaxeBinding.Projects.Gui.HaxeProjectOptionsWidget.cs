...
namespace MonoDevelop.HaxeBinding.Projects.Gui
{
	public partial class HaxeProjectOptionsWidget
	{
		...
		protected virtual void Build ()
		{
			...
			// Container child TargetButton.Gtk.Container+ContainerChild
			...
			w6.LabelProp = global::Mono.Unix.Catalog.GetString ("Browse...");
			w3.Add (w6);
			w2.Add (w3);
			this.TargetButton.Add (w2);
			this.hbox1.Add (this.TargetButton);
			global::Gtk.Box.BoxChild w10 = ((global::Gtk.Box.BoxChild)(this.hbox1 [this.TargetButton]));
			w10.Position = 1;
			w10.Expand = false;
			w10.Fill = false;
			...
			global::Gtk.Table.TableChild w12 = ((global::Gtk.Table.TableChild)(this.table1 [this.TargetLabel]));
